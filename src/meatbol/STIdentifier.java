...
public class STIdentifier extends STEntry {
    ...
    /**
     * Constructor for STIndentifier.
     * @param symbol a string representing the symbol.
     * @param primClassif the primary classification of the STEntry.
     * @param type the data type associated with the identifier.
     * @param struct the structure of the identifier.
     * @param param how the identifier is passed as a parameter.
     * @param address the location of the base address of the identifier.
     */
